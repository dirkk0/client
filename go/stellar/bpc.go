...
type buildPaymentCache struct {
	...
	accountFundedForeverCache      *TimeCache
...
func (s *buildPaymentCache) InformDefaultCurrencyChange(mctx libkb.MetaContext) {
	s.currencyPreferenceCache.Clear()
	s.currencyPreferenceForeverCache.Clear()
}
